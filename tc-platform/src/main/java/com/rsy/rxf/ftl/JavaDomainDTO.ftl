package ${project.basePackage}.dto.business.${model.domain.name?uncap_first};
...
/**
 * ${model.displayName}DTO
 *
 * Created by Recloud
 */
public class ${model.name?cap_first}DTO implements Serializable{
