...
/**
 * ${model.displayName}OneResponseDTO
 * 单个${model.displayName} 响应DTO
 *
 * Created by Recloud
 */
public class ${model.name?cap_first}OneResponseDTO implements Serializable{
    ...
    public ${model.name?cap_first}OneResponseDTO() {
    }

    public ${model.name?cap_first}OneResponseDTO(${model.name?cap_first}DTO ${model.name?uncap_first}DTO) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ${model.name?cap_first}OneResponseDTO)) {
            return false;
        }
        ${model.name?cap_first}OneResponseDTO that = (${model.name?cap_first}OneResponseDTO) o;
