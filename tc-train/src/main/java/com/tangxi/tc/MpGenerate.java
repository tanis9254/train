...
public class MpGenerate {
    ...
    public static void main(String[] args) {
        MpGenerate g = new MpGenerate();
        boolean startWithI = true;
        String projectName = "tc-train";
        String packageName = "com.egao.shicloud.framework";
        String[] tableName = {"department","employee","position"};
    ...
    private DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig().setDbType(DbType.MYSQL)
                .setUrl("jdbc:mysql://localhost:3306/shi_cloud?serverTimezone=Hongkong&nullCatalogMeansCurrent=true&characterEncoding=UTF-8&useSSL=false")
                .setUsername("root")
                .setPassword("123456")
